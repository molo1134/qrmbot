...
proc send_help {nick} {
  ...
  putmsg $nick "  !bands -- display propagation information"
...
#  putmsg $nick "  !southgate -- get news from Southgate"
#  putmsg $nick "  !arrl -- get news from ARRL"
#  putmsg $nick "  !solarvideo -- latest solar conditions from Dr. Skov"
...
#  putmsg $nick "  !ud -- urban dictionary lookup"
  ...
  putmsg $nick "  !repeater -- lookup repeater by callsign"
  putmsg $nick "  !muf -- MUF reports from ionosondes"
  putmsg $nick "  !muf2 -- alt. MUF reports from ionosondes"
  ...
  putmsg $nick "  !sat -- satellite pass predictor"
